<template>
  <div>
   <p class="m-content overflow-line" id="J_description" v-html="introduce"></p>
   <a class="btn-more" v-if="isShowMore" id="J_btnmore" @click="showmoreDesc($event)">查看更多</a>
  </div>
 </template>
 <script>
  export default {
